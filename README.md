...
a persistence unit "backend-cia-aerea" which uses the JakartaEE default database.
...
The configuration can be found in "backend-cia-aerea\pom.xml":
...
artifact ("backend-cia-aerea.war") is already built. You can build
